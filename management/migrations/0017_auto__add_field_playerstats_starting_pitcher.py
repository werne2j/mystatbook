...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerStats.starting_pitcher'
        db.add_column(u'management_playerstats', 'starting_pitcher',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerStats.starting_pitcher'
        db.delete_column(u'management_playerstats', 'starting_pitcher')
