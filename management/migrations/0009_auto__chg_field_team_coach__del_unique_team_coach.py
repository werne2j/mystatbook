...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Team', fields ['coach']
        db.delete_unique(u'management_team', ['coach_id'])


        # Changing field 'Team.coach'
        db.alter_column(u'management_team', 'coach_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Team.coach'
        db.alter_column(u'management_team', 'coach_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Team', fields ['coach']
        db.create_unique(u'management_team', ['coach_id'])
