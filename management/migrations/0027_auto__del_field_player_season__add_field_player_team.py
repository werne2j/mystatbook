...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'management_player', 'season_id')

        # Adding field 'Player.team'
        db.add_column(u'management_player', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['management.Team']),
                      keep_default=False)

        # Adding M2M table for field season on 'Player'
        m2m_table_name = db.shorten_name(u'management_player_season')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('player', models.ForeignKey(orm[u'management.player'], null=False)),
            ('season', models.ForeignKey(orm[u'management.season'], null=False))
        ))
        db.create_unique(m2m_table_name, ['player_id', 'season_id'])


    def backwards(self, orm):
        # Adding field 'Player.season'
        db.add_column(u'management_player', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.Season'], null=True),
                      keep_default=False)

        # Deleting field 'Player.team'
        db.delete_column(u'management_player', 'team_id')

        # Removing M2M table for field season on 'Player'
        db.delete_table(db.shorten_name(u'management_player_season'))
    ...
    models = {
        ...
        u'management.player': {
            ...
            'season': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['management.Season']", 'symmetrical': 'False'}),
