...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DepthChart.team'
        db.delete_column(u'management_depthchart', 'team_id')

        # Adding field 'DepthChart.season'
        db.add_column(u'management_depthchart', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.Season'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DepthChart.team'
        db.add_column(u'management_depthchart', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['management.Team']),
                      keep_default=False)

        # Deleting field 'DepthChart.season'
        db.delete_column(u'management_depthchart', 'season_id')
