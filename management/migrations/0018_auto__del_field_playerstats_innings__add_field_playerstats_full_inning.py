...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlayerStats.innings'
        db.delete_column(u'management_playerstats', 'innings')

        # Adding field 'PlayerStats.full_innings'
        db.add_column(u'management_playerstats', 'full_innings',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.part_innings'
        db.add_column(u'management_playerstats', 'part_innings',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PlayerStats.innings'
        db.add_column(u'management_playerstats', 'innings',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PlayerStats.full_innings'
        db.delete_column(u'management_playerstats', 'full_innings')

        # Deleting field 'PlayerStats.part_innings'
        db.delete_column(u'management_playerstats', 'part_innings')
    ...
    models = {
        ...
        u'management.playerstats': {
            ...
            'part_innings': ('django.db.models.fields.FloatField', [], {}),
            ...
            'starting_pitcher': ('django.db.models.fields.BooleanField', [], {}),
