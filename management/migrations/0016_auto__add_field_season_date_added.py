...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.date_added'
        db.add_column(u'management_season', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Season.date_added'
        db.delete_column(u'management_season', 'date_added')
