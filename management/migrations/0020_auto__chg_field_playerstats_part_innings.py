...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PlayerStats.part_innings'
        db.alter_column(u'management_playerstats', 'part_innings', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'management.playerstats': {
            ...
            'part_innings': ('django.db.models.fields.FloatField', [], {'max_length': '50'}),
