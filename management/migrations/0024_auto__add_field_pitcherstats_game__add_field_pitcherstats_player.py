...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PitcherStats.game'
        db.add_column(u'management_pitcherstats', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['management.Game']),
                      keep_default=False)

        # Adding field 'PitcherStats.player'
        db.add_column(u'management_pitcherstats', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pitchstats', to=orm['management.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PitcherStats.game'
        db.delete_column(u'management_pitcherstats', 'game_id')

        # Deleting field 'PitcherStats.player'
        db.delete_column(u'management_pitcherstats', 'player_id')
