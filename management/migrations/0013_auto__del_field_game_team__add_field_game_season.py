...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.team'
        db.delete_column(u'management_game', 'team_id')

        # Adding field 'Game.season'
        db.add_column(u'management_game', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.Season'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Game.team'
        db.add_column(u'management_game', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['management.Team']),
                      keep_default=False)

        # Deleting field 'Game.season'
        db.delete_column(u'management_game', 'season_id')
