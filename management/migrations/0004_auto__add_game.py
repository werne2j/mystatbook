...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Game'
        db.create_table(u'management_game', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.Team'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('opponent', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('time', self.gf('django.db.models.fields.TimeField')()),
            ('doubleheader', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'management', ['Game'])


    def backwards(self, orm):
        # Deleting model 'Game'
        db.delete_table(u'management_game')
