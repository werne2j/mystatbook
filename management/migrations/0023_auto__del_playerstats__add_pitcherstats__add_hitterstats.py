...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'management_playerstats')

        # Adding model 'PitcherStats'
        db.create_table(u'management_pitcherstats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('starting_pitcher', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('full_innings', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('part_innings', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('hits_allowed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('runs_allowed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('earned_runs', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('walks_allowed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('strikeout_amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('wild_pitches', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('hit_by_pitch', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('win', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('loss', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sv', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'management', ['PitcherStats'])

        # Adding model 'HitterStats'
        db.create_table(u'management_hitterstats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.Game'])),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playerstats', to=orm['management.Player'])),
            ('at_bats', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('runs', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('hr', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('rbi', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('walks', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('hbp', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sacrafice', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('strikeouts', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'management', ['HitterStats'])


    def backwards(self, orm):
        # Adding model 'PlayerStats'
        db.create_table(u'management_playerstats', (
            ('strikeouts', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('win', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('hits_allowed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('part_innings', self.gf('django.db.models.fields.IntegerField')()),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playerstats', to=orm['management.Player'])),
            ('hit_by_pitch', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('walks', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('runs', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.Game'])),
            ('starting_pitcher', self.gf('django.db.models.fields.BooleanField')()),
            ('runs_allowed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('strikeout_amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('loss', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('hits', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'management', ['PlayerStats'])

        # Deleting model 'PitcherStats'
        db.delete_table(u'management_pitcherstats')

        # Deleting model 'HitterStats'
        db.delete_table(u'management_hitterstats')
