...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerStats.part_innings'
        db.alter_column(u'management_playerstats', 'part_innings', self.gf('django.db.models.fields.IntegerField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'PlayerStats.part_innings'
        db.alter_column(u'management_playerstats', 'part_innings', self.gf('django.db.models.fields.FloatField')(max_length=50))
    ...
    models = {
        ...
        u'management.playerstats': {
            ...
            'part_innings': ('django.db.models.fields.IntegerField', [], {'max_length': '50'}),
