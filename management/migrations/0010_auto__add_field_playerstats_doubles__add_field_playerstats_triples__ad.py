...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerStats.doubles'
        db.add_column(u'management_playerstats', 'doubles',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.triples'
        db.add_column(u'management_playerstats', 'triples',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.hbp'
        db.add_column(u'management_playerstats', 'hbp',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.sacrafice'
        db.add_column(u'management_playerstats', 'sacrafice',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerStats.doubles'
        db.delete_column(u'management_playerstats', 'doubles')

        # Deleting field 'PlayerStats.triples'
        db.delete_column(u'management_playerstats', 'triples')

        # Deleting field 'PlayerStats.hbp'
        db.delete_column(u'management_playerstats', 'hbp')

        # Deleting field 'PlayerStats.sacrafice'
        db.delete_column(u'management_playerstats', 'sacrafice')
