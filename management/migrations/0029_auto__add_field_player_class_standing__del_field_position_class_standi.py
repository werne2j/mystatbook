...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.class_standing'
        db.add_column(u'management_player', 'class_standing',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'Position.class_standing'
        db.delete_column(u'management_position', 'class_standing')

        # Deleting field 'Position.year'
        db.delete_column(u'management_position', 'year')


    def backwards(self, orm):
        # Deleting field 'Player.class_standing'
        db.delete_column(u'management_player', 'class_standing')

        # Adding field 'Position.class_standing'
        db.add_column(u'management_position', 'class_standing',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Position.year'
        db.add_column(u'management_position', 'year',
