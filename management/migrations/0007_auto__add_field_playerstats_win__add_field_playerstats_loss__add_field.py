...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerStats.win'
        db.add_column(u'management_playerstats', 'win',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.loss'
        db.add_column(u'management_playerstats', 'loss',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlayerStats.sv'
        db.add_column(u'management_playerstats', 'sv',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerStats.win'
        db.delete_column(u'management_playerstats', 'win')

        # Deleting field 'PlayerStats.loss'
        db.delete_column(u'management_playerstats', 'loss')

        # Deleting field 'PlayerStats.sv'
        db.delete_column(u'management_playerstats', 'sv')
